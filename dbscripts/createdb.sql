...
CREATE TABLE Questionary (
    ...
    OtherDiseases varchar(300)  NOT NULL,
    Medications varchar(150)  NOT NULL,
    SupplementsTaken varchar(300)  NOT NULL,
    AvgSleep decimal(3,2)  NOT NULL,
    UsuallyWakeup time  NOT NULL,
    UsuallyGoToSleep time  NOT NULL,
    DoesExercise boolean  NOT NULL,
    RegularWalk boolean  NOT NULL,
    AverageSportTime decimal(3,2)  NOT NULL,
    SportTypes varchar(300)  NOT NULL,
    ...
    DrinkAlchohol boolean  NOT NULL,
    AlcoholHowOften int  NOT NULL,
    AlchoholBeverages varchar(150)  NOT NULL,
    Smoke boolean  NOT NULL,
    Cigs int  NOT NULL,
    MealsEat int  NOT NULL,
    ...
    FoodHypersensitivity boolean  NOT NULL,
    HypersensitivityProducts boolean  NOT NULL,
    Alergie boolean  NOT NULL,
    AlergieProducts varchar(150)  NOT NULL,
    GoBetweenMeals boolean  NOT NULL,
    BetweenMealsFood varchar(150)  NOT NULL,
...
-- Table: RecommendedMeal
CREATE TABLE RecommendedMeal (
    idRecommendedMeal serial  NOT NULL,
    idMeal int  NOT NULL,
    idDisease int  NOT NULL,
    comment varchar(3000)  NOT NULL,
    CONSTRAINT RecommendedMeal_pk PRIMARY KEY (idRecommendedMeal)
);
...
-- Reference: RecommendedMeal_Diseases (table: RecommendedMeal)
ALTER TABLE RecommendedMeal ADD CONSTRAINT RecommendedMeal_Diseases
    FOREIGN KEY (idDisease)
    REFERENCES Diseases (idDisease)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: RecommendedMeal_Meal (table: RecommendedMeal)
ALTER TABLE RecommendedMeal ADD CONSTRAINT RecommendedMeal_Meal
    FOREIGN KEY (idMeal)
    REFERENCES Meal (idMeal)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
